...
exports.postPedidos = (request, response, next) => {
...
exports.getPedidosEspecificos = (request, response, next) => {
...
exports.patchPedidos = (request, response, next) => {
...
exports.deletePedidos = (request, response, next) => {
